...
# 下载前预筛的硬阈值与黑名单（2026-09-12）：终选本来就拒低清图，先在搜索层
# 把明显不够格的挡在下载带宽外。阈值 320 而不是更高——漏斗实测教训：中文老剧
# 官方剧照标配 550x367（新浪娱乐 2012 年通稿图），400 硬线把「温州一家人 剧照」
# 10 条里 7 条全杀了，活下来的反而是百科与旅游页；真 junk（<320 缩略图）才拦。
_MIN_IMAGE_SIDE = 320
