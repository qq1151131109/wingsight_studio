...
3. **问澄清问题** —— 一次一个；弄清意图 / 参照作品（心里对标的片子/节目/账号）/ 平台与受众 / 约束 /「做完」长什么样
...
- 把验证过的设计（规格）落到画布上一张《片名·策划》卡：标题带片名，
  正文按节写，让导演随时能从画布打开它；告诉导演一句——卡上工具条的
  「全屏」按钮可整屏阅读编辑这份策划（长文写作模式，与卡面实时同步）
...
> 「规格已写到策划卡《片名·策划》上，卡上工具条点『全屏』可整屏看。
>  请过目，开始铺执行之前想改哪里告诉我。」
