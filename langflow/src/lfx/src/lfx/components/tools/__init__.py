...
if TYPE_CHECKING:
    ...
    from .batch_asset_sheet import BatchAssetSheetComponent
    from .calculator import CalculatorToolComponent
    from .feishu_doc import FeishuDocComponent
    from .image_generation import ImageGenerationComponent
    from .promotion_platform_rules import PromotionPlatformRulesComponent
    from .python_repl import PythonREPLToolComponent
    from .search_api import SearchAPIComponent
    from .searxng import SearXNGToolComponent
    from .serp_api import SerpAPIComponent
    from .tavily_search_tool import TavilySearchToolComponent
    from .volc_image_search import VolcImageSearchComponent
    from .wikidata_api import WikidataAPIComponent
    from .wikipedia_api import WikipediaAPIComponent
    from .yahoo_finance import YfinanceToolComponent

_dynamic_imports = {
    "BatchAssetSheetComponent": "batch_asset_sheet",
    ...
    "FeishuDocComponent": "feishu_doc",
    "ImageGenerationComponent": "image_generation",
    "PromotionPlatformRulesComponent": "promotion_platform_rules",
    ...
    "VolcImageSearchComponent": "volc_image_search",
